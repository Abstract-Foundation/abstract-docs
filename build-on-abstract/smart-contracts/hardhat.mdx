...
- [@matterlabs/hardhat-zksync](https://docs.zksync.io/build/tooling/hardhat/hardhat-zksync):
  A suite of Hardhat plugins for working with Abstract.
- [@matterlabs/zksync-contracts](https://docs.zksync.io/build/tooling/hardhat/hardhat-zksync#zksync-contracts):
  Access [system contracts](/how-abstract-works/system-contracts/overview) and other utilities.
