...
<Accordion title="Prerequisites">
  ...
  - [Docker](https://docs.docker.com/get-docker/) is recommended to deploy to a local node, but not required.

<Warning>If you are on Windows, we strongly recommend using [WSL 2](https://learn.microsoft.com/en-us/windows/wsl/about) to follow this guide.</Warning>
</Accordion>
...
<Steps>
  ...
  <Step title="Add your private key" icon="key">
    ...
    Enter the wallet of a new wallet you created for this step.
