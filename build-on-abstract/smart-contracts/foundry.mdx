...
Verify your smart contracts so others can see the code on the [block explorer](/ecosystem/block-explorers):
...
**Note**: Replace the contract address and the contract path with your own.
