---
title: "Layer 2s"
description: "Learn what a layer 2 is and how Abstract is built as a layer 2 to inherit the security properties of Ethereum."
---
...
By posting and verifying batches of transactions to Ethereum,
Abstract provides strong security guarantees while still being able to scale to the demand of consumer crypto;
...
Since Ethereum is only able to process roughly 15 transactions per second, often with
harsh gas fees, it is not feasible for consumer applications to run on Ethereum directly.
