...
<Steps>
  <Step title="Abstract (Processed)">
    ...
    **<Tooltip tip="State diffs offer a more cost-effective approach to transactions than full 
    ...
    calling the `commitBatches` function on the L1 smart contract and ensuring their [data availability](https://ethereum.org/en/developers/docs/data-availability/).
  ...
  <Step title="Ethereum (validating)">
    ...
    `proveBatches` function on the L1 smart contract. 
    ...
    & submitting it to the L1 smart contract and the [verifier](/how-abstract-works/architecture/components/prover-and-verifier)
