...
<Steps>
  ...
  <Step title="Ethereum (validating)">
    ...
    `verifyBatches` function on the L1 smart contract. 

    This process involves both the [prover](/how-abstract-works/architecture/components/prover) responsible for 
    ...
    & submitting it to the L1 smart contract and the [verifier](/how-abstract-works/architecture/components/verifier)
  ...
  <Step title="Ethereum (executing)">
    ...
    by calling the `executeBatches` function on the L1 smart contract.
