...
[ContractDeployer](/system-contracts/list-of-system-contracts#contractdeployer) system contract
using one of it&rsquo;s
[create](#how-abstract-works/evm-differences/contract-deployment#create),
[create2](#how-abstract-works/evm-differences/contract-deployment#create2),
[createAccount](#how-abstract-works/evm-differences/contract-deployment#createaccount), or
[create2Account](#how-abstract-works/evm-differences/contract-deployment#create2account) functions.
...
load the artifact of the contract and use the [Deployer](https://docs.zksync.io/build/tooling/hardhat/plugins/hardhat-zksync-deploy#deployer-export)
class from the [hardhat-zksync](https://docs.zksync.io/build/tooling/hardhat/plugins/hardhat-zksync-deploy) plugin to deploy the contract.
