...
[IAccount](#iaccount-interface) interface. As outlined in the [transaction flow](./transaction-flow),
...
Typically, you would perform some kind of [signature validation](./signature-validation) in this step
to restrict who can use the account. This function must:

1. Increment the nonce for the account. See [handling nonces](./handling-nonces) for more information.
