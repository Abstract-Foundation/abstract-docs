...
If you prefer a one-stop-shop solution, you can use [Zyfi](https://www.zyfi.org/) to integrate paymaster services into your dApps in 1 hour with a simple API call.

The process is straightforward:

1. Create your project on the [Zyfi dashboard](https://www.zyfi.org/dashboard)
2. Deposit ETH to sponsor your transactions.
3. Get your API key.
4. Call the Zyfi API before each on-chain action you want to sponsor.

And that's it! 🎉 (No cost, maximum flexibility)

You can also watch this comprehensive [video tutorial](https://www.youtube.com/watch?v=AukF_sqCMSc) to learn how to integrate Zyfi into your dApp on Abstract.

<Card
  title="Zyfi Paymaster"
  icon="link"
  href="https://www.zyfi.org/dashboard"
/>
