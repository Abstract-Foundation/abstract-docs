...
[IPaymaster](#ipaymaster-interface) interface. As outlined in the [transaction flow](./transaction-flow),
after the [smart contract wallet](./smart-contract-wallets) validates and executes the transaction,
