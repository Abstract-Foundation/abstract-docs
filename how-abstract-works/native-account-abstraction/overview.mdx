...
standard interface, defining the methods that each smart contract account must implement as a minimum.

- Users can still use EOA wallets such as [MetaMask](https://metamask.io/), however, they are "converted" to the 
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
    href="/how-abstract-works/native-account-abstraction/smart-contract-accounts"
  >
    Learn how smart contract accounts on Abstract work and build a smart contract wallet.
    </Card>
  <Card
  ...
  >
    Learn how to build a paymaster and sponsor gas fees for other accounts on Abstract.
  </Card>
</CardGroup>
