...
is made to the [NonceHolder](/how-abstract-works/system-contracts/nonceholder) system contract 
...
from the `NonceHolder` system contract. For example, inside of your [smart contract wallet](/how-abstract-works/native-account-abstraction/smart-contract-wallets.mdx),
