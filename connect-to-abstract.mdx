...
export const ConnectWallet = ({ title }) => {
  return (
    <div id="connect-wallet-container">
      <div id="wallet-content">Loading wallet connection...</div>
      <script dangerouslySetInnerHTML={{__html: `
        (function() {
          function initWallet() {
            const walletContent = document.getElementById('wallet-content');
            walletContent.innerHTML = '<button id="connectWalletBtn" class="connect-wallet-btn">Connect Wallet</button><button id="switchNetworkBtn" class="connect-wallet-btn" style="display:none;">Switch Network</button><strong id="walletStatus"></strong>';
