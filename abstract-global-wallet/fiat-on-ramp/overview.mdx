...
description: "Learn how to allow user's to fund their Abstract Global Wallet with FIAT currencies."
---
...
<CardGroup cols={2}>
  <Card
    ...
    <Card
        ...
        icon="github"
        href="https://github.com/Abstract-Foundation/examples/tree/main/agw-fiat-on-ramp"
    >
...
The FIAT on-ramp works by presenting user&rsquo;s with a **widget** that prompts the user for their payment details to fulfil a **quote**. The quote determines the amount, address, currency, and other details of the transaction.
