...
Use the [`createAbstractClient`](/abstract-global-wallet/agw-client/api/createAbstractClient) function to instantiate a new client.

The given `account` is the EOA that owns the Abstract Global Wallet smart contract. If this account has not yet created an Abstract Global Wallet,
