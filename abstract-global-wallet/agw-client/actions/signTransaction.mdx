...
It extends the [signTransaction](https://viem.sh/docs/actions/wallet/signTransaction) function from Viem to include support for
[EIP-712 transactions on Abstract](/how-abstract-works/evm-differences/transactions).

Transactions are signed by the approved signer account of the Abstract Global Wallet.
...
```tsx
import { signTransaction } from "@abstract-foundation/agw-client";
import { agwClient } from "./config";
import { abstractTestnet } from "viem/chains";
