---
title: "writeContract"
description: Function to interact with a smart contract using the connected Abstract Global Wallet.
---

The [AbstractClient](/abstract-global-wallet/agw-client/createAbstractClient)
includes a `writeContract` method that can be used to interact with a smart contract using the connected Abstract Global Wallet.
...
<ResponseField name="abi" type="Abi" required>
  The ABI of the contract to interact with.
</ResponseField>
