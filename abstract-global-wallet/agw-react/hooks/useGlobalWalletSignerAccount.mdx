...
approved to sign transactions for the connected Abstract Global Wallet. This is helpful if you need to acces the underlying [EOA](https://ethereum.org/en/developers/docs/accounts/#types-of-account)
