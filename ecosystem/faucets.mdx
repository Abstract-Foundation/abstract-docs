...
you can get testnet ETH on Abstract directly or [bridge](/ecosystem/bridges) Sepolia ETH to the
Abstract testnet.
...
Use a [bridge](/ecosystem/bridges) to move Sepolia ETH to the Abstract testnet.
