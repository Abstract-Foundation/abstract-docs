...
Learn how to build apps on Abstract like [Gacha](https://gacha.game/?ref=Q3FMS2SO), which use Proof of Play’s verifiable random number generator (vRNG) service to provide fair, on-chain randomness for outcomes.
...
<Steps>
  ...
  [Contact the Proof of Play team](https://z7a9jnrajv8.typeform.com/to/Ywh9xVFF) to whitelist your smart contract address.

  <Card
    title="Contact the Proof of Play team"
    icon="address-book"
    href="https://z7a9jnrajv8.typeform.com/to/Ywh9xVFF"
  >
