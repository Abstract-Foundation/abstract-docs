...
Change `<container name>` to `external-node_external-node_1`
```bash
docker logs -f --tail 100 <container name>
```
Alternatives `<container name>` : `external-node_prometheus_1` , `external-node_postgres_1` , `external-node_grafana_1`
