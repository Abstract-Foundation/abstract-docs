---
title: "Components"
description: "Learn the components of an Abstract node and how they work together."
---
...
It is worth noting that in addition to fetching the _state_, the Abstract node also retrieves the L1 gas price from the main node
