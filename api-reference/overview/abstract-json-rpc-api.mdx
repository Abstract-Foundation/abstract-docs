...
<CardGroup cols={2}>
  <Card
    ...
    icon="ethereum"
    href="/api-reference/ethereum-json-rpc-api"
  />
  <Card
    title="ZKsync JSON-RPC API"
    href="/api-reference/zksync-json-rpc-api"
    icon={
      <img
  ...
  <Card
    ...
    icon="ban-bug"
    href="/api-reference/debugging-json-rpc-api"
  />
  <Card
    title="PubSub JSON-RPC API"
    icon="webhook"
    href="/api-reference/pubsub-json-rpc-api"
  />
</CardGroup>
